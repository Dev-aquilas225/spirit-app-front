...
const consultations_entity_1 = require("./consultations.entity");
let ConsultationsService = class ConsultationsService {
    constructor(repo) {
        this.repo = repo;
    }
    create(userId, data) { return this.repo.save(this.repo.create({ ...data, userId })); }
...
exports.ConsultationsService = ConsultationsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(consultations_entity_1.ConsultationsEntity)),
