...
let NotificationsService = class NotificationsService {
    ...
    async markRead(userId, id) { await this.repo.update({ id, userId }, { isRead: true }); }
    async markAllRead(userId) { await this.repo.update({ userId }, { isRead: true }); }
    async delete(userId, id) { await this.repo.delete({ id, userId }); }
};
