...
const MODULES = [
  ...
  { id: 'consult', label: 'Voyance',            sub: 'Illimité', icon: Star,      color: '#C9A84C', bg: 'rgba(201,168,76,0.12)',  route: '/(app)/(tabs)/ai' },
  ...
  { id: 'futur',   label: 'Connaître le futur', sub: 'Illimité', icon: Eye,       color: '#2DD4A0', bg: 'rgba(45,212,160,0.12)',  route: '/futur' },
