...
export default function SupportScreen() {
  ...
  const supportOptions = [
    { icon: Mail, label: t.support.email, value: 'tchingangankongeorges@gmail.com', action: () => Linking.openURL('mailto:tchingangankongeorges@gmail.com') },
    { icon: Phone, label: 'Telegram', value: '+225 07 00 50 86 18', action: () => Linking.openURL('https://t.me/+2250700508618') },
