        ...
        <View style={{ flex: 1 }}>
          <View style={s.headerTitleRow}>
            ...
            <Text style={s.headerTitle}>
              {view === 'chat' ? 'Prophète Georges' : 'Mes sessions'}
            </Text>
          </View>
          <Text style={s.headerSub}>
            {view === 'chat' ? programmeTitle : 'Historique des accompagnements'}
          </Text>
        </View>
        {view === 'chat' && (
          <TouchableOpacity
      ...
      <FadeInView style={{ backgroundColor: colors.background }}>
        ...
        {conversations.length === 0 ? (
          <EmptyState
            ...
            title="Aucune session d'accompagnement"
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontWeight: '600', color: colors.text, fontSize: 14 }}>
                      {preview ? truncateText(preview, 50) : 'Session d\'accompagnement'}
                    </Text>
        ...
        <View style={[s.typing, { backgroundColor: colors.surface }]}>
          <View style={s.typingRow}>
            ...
            <Text style={{ color: colors.textSecondary, fontSize: 13 }}>
              Le Prophète Georges vous prépare une réponse…
            </Text>
          </View>
        </View>
      )}
